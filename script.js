...
const statusIcone=(card)=>{
  //open-closed logic
        let statusIcon='';
        if(card.status === "open"){
          statusIcon=`<img class=" w-full" src="assets/Open-Status.png" alt=""></img>`;
        }
        else{
          statusIcon=`<img class=" w-full" src="assets/Closed- Status .png" alt="">`;
        }
        return statusIcon;
}
    ...
    if (label === "bug") {
      return `
        <div class="badge badge-error badge-outline rounded-full flex items-center pl-2 font-bold text-[10px]">
          <span class="relative left-1 pt-[2px]"><img src="assets/Vector.png" alt=""></span>BUG
        </div>
      `;
    } else if (label === "help wanted") {
      return `
        <div class="badge badge-warning badge-outline rounded-full flex items-center pl-2 font-bold text-[10px]">
          <span class="relative left-1 pt-[2px]"><img src="assets/Vector (1).png" alt=""></span>HELP WANTED
        </div>
      `;
    } else if (label === "enhancement") {
      return `
        <div class="badge badge-success badge-outline rounded-full flex items-center pl-2 font-bold text-[10px]">
          <span class="relative left-1 pt-[2px]"><img src="assets/Sparkle.png" alt=""></span>ENHANCEMENT
        </div>
      `;
    } else if (label === "documentation") {
      return `
        <div class="badge badge-primary badge-outline rounded-full flex items-center pl-2 font-bold text-[10px]">
          <span class="relative left-1 pt-[2px]"><img src="assets/Sparkle.png" alt=""></span>DOCUMENTATION
        </div>
      `;
    } else {
      return "";
